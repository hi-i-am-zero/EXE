...
{
    Task<string> GetAuthorizationUrlAsync(Guid userId, Guid projectId, string redirectUri, CancellationToken cancellationToken = default);
    Task<FacebookAccountDto> ConnectAccountAsync(Guid userId, Guid projectId, string authorizationCode, string redirectUri, CancellationToken cancellationToken = default);
