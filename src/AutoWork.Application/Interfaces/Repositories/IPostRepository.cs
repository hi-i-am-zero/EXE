...
public interface IPostRepository : IRepository<Post>
{
    ...
    Task<IReadOnlyList<Post>> GetPagedAsync(Guid userId, int pageNumber, int pageSize, int? status = null, Guid? timelineId = null, CancellationToken cancellationToken = default);
    Task<int> CountByUserIdAsync(Guid userId, int? status = null, Guid? timelineId = null, CancellationToken cancellationToken = default);
