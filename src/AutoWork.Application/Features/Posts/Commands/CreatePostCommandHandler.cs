...
public class CreatePostCommandHandler : IRequestHandler<CreatePostCommand, PostDto>
{
    ...
    public async Task<PostDto> Handle(CreatePostCommand command, CancellationToken cancellationToken)
    {
        ...
        var brandProfile = (await _brandProfiles.FindAsync(b => b.ProjectId == command.Request.ProjectId, cancellationToken)).FirstOrDefault();
        var contentWithFooter = PostContentFooterBuilder.AppendBrandFooter(command.Request.Content, brandProfile);
